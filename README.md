...
```
src/content/stocks/workplace-blackmail-types.md
```

或新增一篇新的：

```
src/content/stocks/another-topic.md
```
...
> 這一步是「寫作者安全帶」，不是必須，但很值得。

------

### 🟢 Step 3｜把變更交給 Git（最重要）
...
```
new file: src/content/stocks/another-topic.md
```
...
```
git add .
git commit -m "content: add new stock article"
git push
```

------

### 🟢 Step 4｜什麼事情會自動發生（你不用管）
...
```
https://thomastsao0704.github.io/BLOG/
```
